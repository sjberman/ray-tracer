...
// multiplies two matrices (vector of vectors) together and returns a matrix
// (vector of vectors)
...
std::vector<float> vectorMatrixMultiply(const matrixvector &A,
...
std::vector<float> scalarVectorMultiply(const float s,
...
// adds two vectors
std::vector<float> addVector(const std::vector<float> &A,
                             const std::vector<float> &B) {
...
std::vector<float> subtractVector(const std::vector<float> &A,
                                  const std::vector<float> &B) {
...
std::vector<float> surfaceNormal(const std::vector<float> &A,
                                 const std::vector<float> &B,
